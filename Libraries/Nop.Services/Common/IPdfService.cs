...
namespace Nop.Services.Common
{
    ...
    public partial interface IPdfService
    {
        ...
        /// <summary>
        /// Print quote request products to PDF
        /// </summary>
        /// <param name="stream">Stream</param>
        /// <param name="products">Products</param>
        /// 
        Task PrintQuoteRequestToPdf(Stream stream, IList<Order> orders, IList<UWProductDetailsModel> productDetailsList, int languageId = 0, int vendorId = 0);
    }
}