...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        /// <returns>
        /// A task that represents the asynchronous operation
        /// The task result contains the all products
        /// </returns>
        public virtual async Task<IPagedList<Product>> SearchAllProductsAsync(
        //public virtual async Task<IList<Product>> SearchAllProductsAsync(
            int pageIndex = 0,
            int pageSize = int.MaxValue,
            IList<int> categoryIds = null,
            IList<int> manufacturerIds = null,
            ...
            bool? overridePublished = null)
        {
            ...
            //var testl = productsQuery.ToList();
            //var testc = productsQuery.ToList().Count;
            //var test = productsQuery;
            //var prtest = productsQuery.OrderBy(orderBy);
            //var res= await productsQuery.OrderBy(orderBy).ToListAsync();

            return await productsQuery.OrderBy(orderBy).ToPagedListAsync(pageIndex,productsQuery.ToList().Count);
            //return await productsQuery.OrderBy(orderBy).ToListAsync();
            //return await productsQuery.OrderBy(orderBy).ToPagedListAsync(pageIndex,pageSize);
        }
