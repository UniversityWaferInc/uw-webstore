...
namespace Nop.Web.Controllers
{
    ...
    public partial class ProductController : BasePublicController
    {
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task<IActionResult> ProductDetails(int productId, int updatecartitemid = 0,bool IsModelPopup=false)
        {
            ...
            //to differentiate the window popup and default product view call
            if (IsModelPopup.Equals(true))
            {
                productTemplateViewPath = "ProductDetailModelPopup";
                return View(productTemplateViewPath, model);
            }
